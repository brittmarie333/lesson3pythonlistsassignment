...
def Alice (submitted, attended):
    if Alice in attended and submitted:
        print(f"Alice was in class and submitted her assingment!")
    else:
        print(f"Alice was not in class or submitted assingment!")
